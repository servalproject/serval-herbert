...
/**
 * class to receive the intent when the phone boots to start the CoreService automatically
 */
public class SystemEventReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if(intent.getAction().equals("android.intent.action.BOOT_COMPLETED") == true) {
			// notification that the phone has completed booting
			// start the core service
			
			Intent mIntent = new Intent(context, org.servalproject.herbert.CoreService.class);
